    ...
    <footer className="bg-[#232122] text-white pt-16 pb-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-serif font-semibold mb-6 text-[#C1A35F]">Stay Updated</h4>
            <p className="mb-4 text-sm">Subscribe to our newsletter for special offers and photography tips.</p>

            {subscribed ? (
              <div className="p-3 bg-[#C1A35F] bg-opacity-20 rounded-lg text-center">
                <p className="text-[#C1A35F] font-medium">Thank you for subscribing!</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col space-y-3">
                <input
                  ...
                  className="px-4 py-2 bg-[#F5F3EF] bg-opacity-10 rounded-lg border border-[#C1A35F] border-opacity-30 focus:outline-none focus:ring-2 focus:ring-[#C1A35F] text-white placeholder-gray-400"
                  required
                />
                <button
                  type="submit"
                  className="px-4 py-2 bg-[#C1A35F] hover:bg-[#b09352] rounded-lg font-medium transition-colors"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center justify-start">
              ...
              <div>
                ...
                <p className="text-white">N paravoor</p>
              </div>
            </div>
          </div>
        </div>
